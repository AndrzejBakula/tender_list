...
urlpatterns = [
    ...
    path('add_investor_poviat/<int:investor_id>', AddInvestorPoviat.as_view(), name='add-investor-poviat'),
    path('investors/', InvestorsView.as_view(), name='investors'),
    path('investor_details/<int:investor_id>', InvestorDetails.as_view(), name='investor-details'),
    path('edit_investor/<int:investor_id>', EditInvestor.as_view(), name='edit-investor'),
    path('edit_investor_poviat/<int:investor_id>', EditInvestorPoviat.as_view(), name='edit-investor-poviat'),
    path('add_company/', AddCompany.as_view(), name='add-company'),
    path('add_company_poviat/<int:company_id>', AddCompanyPoviat.as_view(), name='add-company-poviat'),
    ...
    path('company_details/<int:company_id>', CompanyDetails.as_view(), name='company-details'),
    path('edit_company/<int:company_id>', EditCompany.as_view(), name='edit-company'),
    path('edit_company_poviat/<int:company_id>', EditCompanyPoviat.as_view(), name='edit-company-poviat'),
    path('delete_company/<int:company_id>', DeleteCompany.as_view(), name='delete-company'),
    path('delete_company_confirm/<int:company_id>', DeleteCompanyConfirm.as_view(), name='delete-company-confirm'),
    path('add_designer/', AddDesigner.as_view(), name='add-designer'),
    path('add_designer_poviat/<int:designer_id>', AddDesignerPoviat.as_view(), name='add-designer-poviat'),
    path('designers/', DesignersView.as_view(), name='designers'),
    path('designer_details/<int:designer_id>', DesignerDetails.as_view(), name='designer-details'),
    path('edit_designer/<int:designer_id>', EditDesigner.as_view(), name='edit-designer'),
    path('edit_designer_poviat/<int:designer_id>', EditDesignerPoviat.as_view(), name='edit-designer-poviat'),
    path('add_project/', AddProject.as_view(), name='add-project'),
    path('add_project_poviat/<int:project_id>', AddProjectPoviat.as_view(), name='add-project-poviat'),
    path('projects/', Projects.as_view(), name='projects'),
    path('project_details/<int:project_id>', ProjectDetails.as_view(), name='project-details'),
    path('edit_project/<int:project_id>', EditProject.as_view(), name='edit-project'),
    path('edit_project_poviat/<int:project_id>', EditProjectPoviat.as_view(), name='edit-project-poviat'),
    path('delete_project/<int:project_id>', DeleteProject.as_view(), name='delete-project'),
    path('delete_project_confirm/<int:project_id>', DeleteProjectConfirm.as_view(), name='delete-project-confirm'),
    path('delete_investor/<int:investor_id>', DeleteInvestor.as_view(), name='delete-investor'),
    path('delete_investor_confirm/<int:investor_id>', DeleteInvestorConfirm.as_view(), name='delete-investor-confirm'),
    path('delete_designer/<int:designer_id>', DeleteDesigner.as_view(), name='delete-designer'),
    path('delete_designer_confirm/<int:designer_id>', DeleteDesignerConfirm.as_view(), name='delete-designer-confirm'),
    ...
    path('division_choice_confirm/<int:division_id>', DivisionChoiceConfirm.as_view(), name='division-choice-confirm'),
    path('division_details/<int:division_id>', DivisionDetails.as_view(), name='division-details'),
    path('edit_division/<int:division_id>', EditDivisionView.as_view(), name='edit-division'),
    path('delete_division/<int:division_id>', DeleteDivisionView.as_view(), name='delete-division'),
    path('delete_division_confirm/<int:division_id>', DeleteDivisionConfirm.as_view(), name='delete-division-confirm'),
    ...
    path('make_winner/<int:tender_id>/<int:tenderer_id>', MakeWinnerView.as_view(), name='make-winner'),
    path('remove_winner/<int:tender_id>/<int:tenderer_id>', RemoveWinnerView.as_view(), name='remove-winner'),
    ...
    path('add_missing_criteria/<int:project_id>/<int:tender_id>/<int:criteria_id>', AddMissingCriteria.as_view(), name='add-missing-criteria'),
    path('add_missing_deadline/<int:project_id>/<int:tender_id>/<int:tenderer_id>', AddMissingDeadline.as_view(), name='add-missing-deadline'),
    path('add_missing_guarantee/<int:project_id>/<int:tender_id>/<int:tenderer_id>', AddMissingGuarantee.as_view(), name='add-missing-guarantee'),
    path('delete_other_criteria/<int:project_id>/<int:tender_id>/<int:criteria_id>', DeleteOtherCriteriaView.as_view(), name='delete-other-criteria'),
