...
urlpatterns = [
    ...
    path('edit_investor_poviat/<int:id>', EditInvestorPoviat.as_view(), name='edit-investor-poviat'),
    ...
    path('delete_company_confirm/<int:id>', DeleteCompanyConfirm.as_view(), name='delete-company-confirm'),
